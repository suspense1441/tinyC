...
ofstream out;
vector<quad> arr;
string asmfilename = "ass6_19CS30011_";
string inputfile = "ass6_19CS30011_test";
...
{
	arr = q.Array;
	for (vector<quad>::iterator it = arr.begin(); it != arr.end(); it++)
	{
		int i;
	...
	for (std::map<int, int>::iterator it = lMap.begin(); it != lMap.end(); ++it)
		it->second = count++;
	...
	for (vector<quad>::iterator it = arr.begin(); it != arr.end(); it++)
	{
		if (lMap.count(it - arr.begin()))
		{
			sfile << ".L" << (2 * labelCt + lMap.at(it - arr.begin()) + 2) << ": " << endl;
		}
		...
		else
		{
			...
			else if (op == "EQOP")
			{
				...
				sfile << "\tje .L" << (2 * labelCt + lMap.at(atoi(result.c_str())) + 2);
			}
			else if (op == "NEOP")
			{
				sfile << "movl\t" << table->ar[arg1] << "(%rbp), %eax\n";
				sfile << "\tcmpl\t" << table->ar[arg2] << "(%rbp), %eax\n";
				sfile << "\tjne .L" << (2 * labelCt + lMap.at(atoi(result.c_str())) + 2);
			}
			else if (op == "LT")
			{
				sfile << "movl\t" << table->ar[arg1] << "(%rbp), %eax\n";
				sfile << "\tcmpl\t" << table->ar[arg2] << "(%rbp), %eax\n";
				sfile << "\tjl .L" << (2 * labelCt + lMap.at(atoi(result.c_str())) + 2);
			}
			else if (op == "GT")
			{
				sfile << "movl\t" << table->ar[arg1] << "(%rbp), %eax\n";
				sfile << "\tcmpl\t" << table->ar[arg2] << "(%rbp), %eax\n";
				sfile << "\tjg .L" << (2 * labelCt + lMap.at(atoi(result.c_str())) + 2);
			}
			else if (op == "GE")
			{
				sfile << "movl\t" << table->ar[arg1] << "(%rbp), %eax\n";
				sfile << "\tcmpl\t" << table->ar[arg2] << "(%rbp), %eax\n";
				sfile << "\tjge .L" << (2 * labelCt + lMap.at(atoi(result.c_str())) + 2);
			}
			else if (op == "LE")
			{
				sfile << "movl\t" << table->ar[arg1] << "(%rbp), %eax\n";
				sfile << "\tcmpl\t" << table->ar[arg2] << "(%rbp), %eax\n";
				sfile << "\tjle .L" << (2 * labelCt + lMap.at(atoi(result.c_str())) + 2);
			}
			else if (op == "GOTOOP")
			{
				sfile << "jmp .L" << (2 * labelCt + lMap.at(atoi(result.c_str())) + 2);
			}
